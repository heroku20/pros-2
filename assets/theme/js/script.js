...
$jscomp.polyfill = function(b, k, d, q) {
    if (k) {
        ...
        q = d[b];
        k = k(q);
        k != q && null != k && $jscomp.defineProperty(d, b, {
            configurable: !0,
            writable: !0,
            value: k
        })
...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, d, q) {
        ...
        if ("function" == typeof p) {
            b = p.call(b);
            for (var u = 0; !(p = b.next()).done;) k.push(d.call(q, p.value, u++))
        } else
...
(function() {
    ...
    var h, n, v = "function" == typeof jQuery;
    v && (h = jQuery);
    h ? n = h("html").hasClass("is-builder") : n = document.querySelector("html").classList.contains("is-builder");
    ...
    m(function() {
                ...
                if (b) {
                    ...
                    if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                        ...
                        var g = function() {
                            ...
                            f.style.width = null;
                            f.clientWidth < c && (f.style.width = "100%", f.style.height = null)
                        };
        ...
        if (v) h(document).on("add.cards changeParameter.cards", function(c) {
        ...
        if ("undefined" !==
            ...
            if (n) {
                ...
                h(document).on("changeParameter.cards", function(a, b, e, l) {
                    if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", h(a.target).find(".mbr-background-video-preview").remove(),
                        h(a.target).find(".mbr-background-video").remove(), l) {
                        case "type":
        ...
        if (v) h(document).on("add.cards delete.cards", function(a) {
            g && clearTimeout(g);
        ...
        if (v) h(document).on("add.cards", function(a) {
        ...
        if (n) h(document).on("changeParameter.cards", function(a, b, c, l) {
            if ("bg" === b) switch (l) {
                case "type":
                    ...
                    do
                        if (b.hash) {
                            ...
                            document.querySelectorAll(c ? "body" : b.hash).forEach(function(c) {
                                ...
                                e = "#bottom" == b.hash ? d(c) - window.innerHeight : k(c).top - (e ? 60 : 0);
    ...
    if (!n) {
        if (v && h.fn.socialLikes) h(document).on("add.cards", function(a) {
                ...
                var a = function() {
                        ...
                        d.forEach(function(d) {
                            var l = d.offsetHeight,
                                g = e(d);
                            (g + l >= a && g - 50 <= c || b(d)) && d.classList.contains("hidden") && (d.classList.remove("hidden"), d.classList.add("animate__fadeInUp"), d.classList.add("animate__delay-1s"), d.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
    ...
    if (!n && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./))) h(document).on("add.cards",
        function(a) {
            var b = a.target;
            ...
            var a = function(a) {
                ...
                b = function(b) {
                    ...
                    if (d) {
                        ...
                        var h =
                            c.parentNode.querySelector("video");
                        h && h.play && h.play()
                    }
                    var k = b.parents("section")[0],
                        f = k.querySelector(k.querySelector("[data-modal]").getAttribute("data-modal"));
                    f.style.display = "table";
                    f.addEventListener("click", function(b) {
                        d ? (-1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), -1 !== d.indexOf("vimeo") && e.pause()) : (b = c.parentNode.querySelector("video")) && b.stop && b.stop();
    ...
    if (!n) {
        ...
        !x() && (w = document.querySelector("section.menu")) && (A = window.innerWidth, !w.querySelector(".navbar").classList.contains("collapsed") &&
            991 < A && (w.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function(a) {
    ...
    if (n) h(document).on("add.cards changeParameter.cards", function(a, b) {
    ...
    if (n && v) h(document).on("add.cards", function(a) {
        h(a.target).hasClass("testimonials-slider") && y(a.target)
    }).on("changeParameter.cards", function(a, b, d) {
        "testimonialsSlides" === b && 0 == h(a.target).find(".carousel-item.active").length && B(a.target)
    });
